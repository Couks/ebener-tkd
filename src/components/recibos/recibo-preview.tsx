      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="mb-6 text-md">
            Eu, <span className="font-semibold">Ebener dos Santos Pinto</span>,
            inscrito no <span className="font-semibold">CPF</span> sob o{" "}
            <span className="font-semibold">n.º 073117777-04</span> e registrado
            no <span className="font-semibold">CREF</span> sob o{" "}
            <span className="font-semibold">n.º 008141</span>, declaro para os
            devidos fins que recebi de:
          </p>
          ...
          <p className="mb-6 text-md">
            ...
            <span className="font-semibold">
              R$ {formData.valor || "_________"}
            </span>
            , referente as aulas de Taekwondo realizadas duas vezes por semana,
            no período correspondente ao mês de{" "}
            <span className="font-semibold">
              {formData.mes || "___________"}
            </span>{" "}
            de 20
            <span className="font-semibold">
              {formData.ano?.substring(2) || "__"}
            </span>
            .
          </p>

          <p className="mb-6 sm:mb-8 text-md">
            As aulas foram ministradas de forma regular, conforme combinado
            previamente.
          </p>

          <p className="text-center mb-6 sm:mb-8 text-md">
            Rio de Janeiro, <span>{formData.dia || "__"}</span>/
            <span>{formData.mesAtualNumero || "__"}</span>/20
